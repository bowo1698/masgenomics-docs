...
in the R environment, rather than when this page runs. It requires the
Bioconductor package `snpStats` and can then be installed from its public
source tarball with `install.packages("https://github.com/SFUStatgen/LDheatmap/archive/refs/heads/master.tar.gz", repos = NULL, type = "source")`.
